namespace Spider.Pipelines.Samples.Basic
{
    ...
    /// <summary>
    /// Provides a sample execution boundary selected from a pipeline fluent configuration.
    /// </summary>
    public sealed class FluentConsoleBoundary : IPipelineExecutionBoundary
    {
        private readonly SampleEventLog _log;

        /// <summary>
        /// Initializes a new instance of the <see cref="FluentConsoleBoundary"/> class.
        /// </summary>
        /// <param name="log">The sample event log.</param>
        public FluentConsoleBoundary(SampleEventLog log)
        {
            _log = log;
        }
        ...
        {
            _log.Write($"fluent boundary: begin {context.RequestType.Name}");
        ...
        {
            _log.Write("fluent boundary: complete");
            return ValueTask.CompletedTask;
        }
        ...
        {
            _log.Write($"fluent boundary: fault {exception.GetType().Name}");
            return ValueTask.CompletedTask;
        }
        ...
        {
            _log.Write("fluent boundary: cancel");
            return ValueTask.CompletedTask;
        }
    }
}
