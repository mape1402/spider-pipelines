namespace Spider.Pipelines.Boundaries.Internals
{
    ...
    internal sealed class ExecutionBoundaryCollection<TRequest> : IExecutionBoundaryCollection<TRequest>
    {
        ...
        /// <inheritdoc/>
        public IExecutionBoundaryCollection<TRequest> AddExecutionBoundary(Type boundaryType)
        {
        ...
        /// <inheritdoc/>
        public IExecutionBoundaryCollection<TRequest> AddBoundary(Type boundaryType)
